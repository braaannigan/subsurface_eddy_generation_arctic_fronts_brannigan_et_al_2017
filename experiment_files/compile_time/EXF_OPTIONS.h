...
c#define  ALLOW_ATM_TEMP
#define  ALLOW_ATM_WIND
c#define  ALLOW_DOWNWARD_RADIATION
c#define  ALLOW_RUNOFF
...
c# undef ALLOW_ZENITHANGLE
c#endif

C   Relaxation to monthly climatologies.
c#define ALLOW_CLIMSST_RELAXATION
c#define ALLOW_CLIMSSS_RELAXATION
